...
public class Johnson_NestedLoop{
  public static void main(String[] args) {
    ...
    System.out.println("7 programs available to run: \n1: Multiplication Table, 2-5: Designs, 6: Diamond, 7: Teeth \n\nEnter the desired program or 0 to exit: \t");
    ...
    while(programNumber!=0){ 
      ...
      if(programNumber == 4){
        ...
        String initial2 = keyboard.nextLine();
        for(int d=1; d<=5; d++){
          int e;
          for(e=1; e<=d; e++){
            System.out.print(initial);
